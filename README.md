...
1. **按单元复习**：顶部导航切换 Unit 1–8，逐单元背诵答案。
2. **对照原文**：点击「显示原文与译文」，结合听力材料理解语境。
3. **遮盖记忆**：关闭「显示所有选项」，只看高亮正确答案强化记忆。
4. **考前自测**：点击「随机答题」，检验掌握程度。
...
如有问题或建议，欢迎提交 [Issue](https://github.com/moqix26/fx-a2sts/issues)。
